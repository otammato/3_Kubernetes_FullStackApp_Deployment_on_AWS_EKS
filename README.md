...
>
> The manifest involves environment variables as the Node.js script suggests using ether default variables or the provided ones for connecting to the database.
> <p align="center" >
